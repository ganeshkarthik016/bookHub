...
export default function CreatePlaylistModal() {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            // TODO: Call your createPlaylist service here
            // const newPlaylist = await createPlaylist({ name, shortNotes, isPrivate });
            
            setName("");
            setShortNotes("");
            setIsPrivate(false);
            dispatch(closeModal());
            // TODO: dispatch action to add new playlist to Redux store
        } catch (err) {
        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="mt-2 flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="playlistPrivate" className="text-sm font-medium text-gray-700">
